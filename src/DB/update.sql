...
ALTER TABLE inventario_auxiliar ADD COLUMN IF NOT EXISTS autorizado int not null default 0;
ALTER TABLE inventario_auxiliar ADD COLUMN IF NOT EXISTS fecha_cierre date;
ALTER TABLE inventario_auxiliar ADD COLUMN IF NOT EXISTS hora_cierre time;
...
ALTER TABLE detalle_compras ADD COLUMN IF NOT EXISTS dc_cantidad_verificada INT NOT NULL DEFAULT 0;

-- Agregar columnas a compras si no existen
ALTER TABLE compras ADD COLUMN IF NOT EXISTS co_verificado INT NOT NULL DEFAULT 0;
ALTER TABLE compras ADD COLUMN IF NOT EXISTS co_responsable_ubicacion INT NOT NULL DEFAULT 0;
ALTER TABLE compras ADD COLUMN IF NOT EXISTS co_verificador INT NOT NULL DEFAULT 0;
ALTER TABLE compras ADD COLUMN IF NOT EXISTS co_confirmador INT NOT NULL DEFAULT 0;
...
ALTER TABLE pedidos ADD COLUMN IF NOT EXISTS p_imprimir_preparacion int not null default 0;
ALTER TABLE pedidos ADD COLUMN IF NOT EXISTS p_preparado_por int not null default 0;
ALTER TABLE pedidos ADD COLUMN IF NOT EXISTS p_cantidad_cajas int not null default 0;
ALTER TABLE pedidos ADD COLUMN IF NOT EXISTS p_verificado_por int not null default 0;
